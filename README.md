...
```bash
# Hacker Roadmap
# Ethical hacking guide for pen testers
# Written like code, visible in the repo
```

This repository is a guide for amateur pen testers and a summary of hacking tools to practice ethical hacking, penetration testing, and web security. Most of these tools are UNIX compatible and MIT licensed. *Note that Linux is the best operating system to practice ethical hacking.*

**Important note :** I am NOT a professional pen tester or infosec expert, I am just a student who wants to learn and teach others. Feel free to contribute and provide corrections!
